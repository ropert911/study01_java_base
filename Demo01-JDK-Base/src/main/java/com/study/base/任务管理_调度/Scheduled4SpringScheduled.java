...
@EnableScheduling
@Component
public class Scheduled4SpringScheduled {
    private static Logger LOGGER = LoggerFactory.getLogger(Scheduled4SpringScheduled.class);
    ...
    public static void main(String[] args) {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(Scheduled4SpringScheduled.class);
//        context.close();
    }
}
