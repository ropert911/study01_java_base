package com.study.base.schedule.elasticjob.config;
...
import com.study.base.schedule.elasticjob.Job.EJob1;
import com.study.base.schedule.elasticjob.Job.EJob2;
...
public class JobConfig {
    ...
    public JobScheduler createjob1Schedular(final EJob1 job1) {
        String cron = "5/5 * * * * ?";
        int shareTotalCount = 2;         //任务分成2片来做
