...
public interface HistoryConfigInfoMapper {
     ...
     * @param cinfo
     */
    @Insert("INSERT INTO history_config(config_id,device_id,create_time,config_status,business_type,config_info,config_result) VALUES " +
     ...
     * @param configInfos
     */
    @Insert("<script>INSERT INTO history_config(config_id,device_id,create_time,config_status,business_type,config_info,config_result) VALUES " +
            "<foreach collection='infos' item='info' open='' separator=',' close=''>" +
            "(#{info.configId},#{info.deviceId},#{info.createTime},#{info.configStatus},#{info.businessType},#{info.configInfo},#{info.configResult})" +
            "</foreach>" +
            "</script>")
    void batchInsert(@Param("infos") List<ConfigInfo> configInfos);
     ...
     * @param configId
     */
    @Delete("DELETE FROM history_config WHERE config_id =#{configId}")
     ...
     * @param ids
     */
    @Delete("<script>delete  from history_config where config_id in " +
     ...
     * @param configStatus
     */
    @Update("UPDATE history_config SET config_status=#{configStatus} WHERE config_id=#{configId}")
     ...
     */
    @Update("UPDATE history_config SET config_status=#{configStatus},config_time=#{configTime},config_result=#{configResult} WHERE config_id =#{configId}")
     ...
     * @param configResult
     */
    @Update("UPDATE history_config SET config_result=#{configResult} WHERE config_id =#{configId}")
     ...
     * @return
     */
    @Select("SELECT * FROM history_config WHERE config_id = #{configId}")
    @Results({
     ...
     * @return
     */
    @Select("SELECT * FROM history_config")
    @Results({
            @Result(property = "configId", column = "config_id"),
            @Result(property = "deviceId", column = "device_id"),
            @Result(property = "createTime", column = "create_time"),
     ...
     * @return
     */
    @Select("select * from history_config where device_id =#{deviceId} and config_status = 1 order by create_time ASC")
    @Results({
            @Result(property = "configId", column = "config_id"),
            @Result(property = "deviceId", column = "device_id"),
            @Result(property = "createTime", column = "create_time"),
     ...
     * @return
     */
    @Select("select * from history_config where device_id =#{deviceId} and business_type=#{businessType}")
    @Results({
            @Result(property = "configId", column = "config_id"),
            @Result(property = "deviceId", column = "device_id"),
            @Result(property = "createTime", column = "create_time"),
     ...
     * @return
     */
    @Select("<script>select * from history_config where config_id in " +
     ...
     * @return
     */
    @Select("select * from history_config where create_time<#{timeoutTime}")
    @Results({
            @Result(property = "configId", column = "config_id"),
            @Result(property = "deviceId", column = "device_id"),
            @Result(property = "createTime", column = "create_time"),
