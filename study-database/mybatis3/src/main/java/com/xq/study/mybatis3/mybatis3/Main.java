package com.xq.study.mybatis3.mybatis3;

import java.io.Reader;
import java.text.MessageFormat;
import java.util.List;

import com.xq.study.mybatis3.mybatis3.dao.IUser;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //User user = (User) session.selectOne( "yiibai.mybatis.models.UserMapper.getUserByID", 1);
